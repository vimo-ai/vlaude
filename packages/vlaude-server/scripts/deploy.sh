...
# 数据库配置
DATABASE_URL="${DATABASE_URL:-mysql://root:***REMOVED-mysql***@10.0.0.1:6603/vlaude}"

# Daemon 配置 (vlaude-daemon 运行在 Mac 上)
DAEMON_HOST="${DAEMON_HOST:-10.0.0.1}"
...
# IP 白名单
IP_WHITELIST="${IP_WHITELIST:-10.0.0.1/24,127.0.0.1,::1}"
